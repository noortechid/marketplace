...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white w-full max-w-sm p-6 sm:p-8 rounded-3xl shadow-xl">
        ...
        <form method="POST" action="modules/auth/login.php" class="space-y-5">
            ...
            <div class="text-right">
                <a href="#" class="text-blue-800 text-sm font-semibold hover:underline">
                    Forgot Password?
                </a>
            </div>
        ...
        <div class="mt-6 text-center text-gray-700 text-sm">
            ...
            <a href="register.php" class="text-blue-800 font-bold hover:underline">
                Sign up
            </a>
        </div>
